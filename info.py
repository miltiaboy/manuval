...
BOT_TOKEN = environ.get('BOT_TOKEN', '7774372888:AAHzmHDQyV-xYjdA28OeJkmXwaJ0BW0bX_o')
...
CHANNELS = [int(ch) if id_pattern.search(ch) else ch for ch in environ.get('CHANNELS', '-1002397004421 -1002479401977').split()]
